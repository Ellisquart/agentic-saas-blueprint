  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        'display-xs': ['20px', { lineHeight: '28px', letterSpacing: '0' }],
        'display-sm': ['25px', { lineHeight: '32px', letterSpacing: '0' }],
        'display-md': ['31px', { lineHeight: '38px', letterSpacing: '0' }],
        'display-lg': ['39px', { lineHeight: '44px', letterSpacing: '0' }],
        'display-xl': ['49px', { lineHeight: '54px', letterSpacing: '0' }],
      },
      maxWidth: {
        content: '56rem',
        layout: '72rem',
